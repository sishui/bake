...
type User struct {
	...
	Email     string    `bun:"email,unique,notnull" form:"email" json:"email,omitempty"`                                   //
	StartAt   time.Time `bun:"start_at,notnull,default:current_timestamp" form:"start_at" json:"start_at,omitempty"`       //
	EndAt     time.Time `bun:"end_at,notnull,default:current_timestamp" form:"end_at" json:"end_at,omitempty"`             //
